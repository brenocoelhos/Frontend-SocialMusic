      ...
      <v-container>
        ...
        <v-row v-else>
          <v-col v-for="avaliacao in avaliacoes" :key="avaliacao.id" cols="12" md="6" lg="4">
            <v-card rounded="lg" class="d-flex flex-column" style="height: 260px; overflow: hidden;">
              ...
              <v-card-text class="text-grey-darken-1" style="flex: 0; overflow: hidden; padding: 0 16px; line-height: 1.4;">{{ avaliacao.comentario }}</v-card-text>
